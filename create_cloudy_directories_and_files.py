...
def main(fdirs, verbose):

    # Read file
    centers = read_centers(base_fdir=fdirs['python_files_dir'], file_name="nzone_problematic_runs.txt")
    ...
    #################### Create .in files
    fdir = fdirs['cloudy_runs_files_dir']
...
def read_centers(base_fdir, file_name):
    """
...
def create_in_file(file_name, center, redshift, cosmic_ray):
    ...
    try:
        with open(file_name, "w") as fp:
            ...
            # fp.write("set nend 5000\n")  # Set number limiting number of zones.
            fp.write("set nend 20000\n")  # Set number limiting number of zones. # TODO
...
if __name__ == "__main__":
    ...
    # Niagara clusters
    # fdir = "/bb/m/murray/dtolgay/unfinished_run_cr_1_CO87_CII_H_O3_metallicity_above_minus_2"
    ...
    main(fdirs=fdirs, verbose=False)